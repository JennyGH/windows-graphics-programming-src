...
void KImageModule::TranslateName(PCSTR SymbolName)
{
...
BOOL KImageModule::EnumSymbolsCallback(PCSTR SymbolName, ULONG SymbolAddress, ULONG SymbolSize)
{
    unsigned callid = 0;
    unsigned parano = 0;
...
BOOL CALLBACK EnumSymbolsCallback(PCSTR SymbolName, ULONG SymbolAddress, ULONG SymbolSize,
    PVOID UserContext)
{
